...
set_window_value(AT_FAIR, 4, AG_WINDOW_LENGTH, 13); //16
...
set_hitbox_value(AT_FAIR, 1, HG_SHAPE, sprite_get("sweetspot_hitbox"));
set_hitbox_value(AT_FAIR, 1, HG_SHAPE, 0);
set_hitbox_value(AT_FAIR, 1, HG_PRIORITY, 8); //high priority
...
set_hitbox_value(AT_FAIR, 3, HG_LIFETIME, get_window_value(AT_FAIR, 2, AG_WINDOW_LENGTH));
...
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_HSPEED, 1);
...
set_hitbox_value(AT_FAIR, 4, HG_LIFETIME, get_window_value(AT_FAIR, 2, AG_WINDOW_LENGTH));

set_hitbox_value(AT_FAIR, 4, HG_HITBOX_X, 34);
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_Y, -72);
set_hitbox_value(AT_FAIR, 4, HG_WIDTH, 54);
set_hitbox_value(AT_FAIR, 4, HG_HEIGHT, 27);
...
set_hitbox_value(AT_FAIR, 4, HG_ANGLE, 80);
...
set_hitbox_value(AT_FAIR, 4, HG_HITPAUSE_SCALING, 0.3);
...
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_X, -9);
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_Y, 0);
set_hitbox_value(AT_FAIR, 5, HG_WIDTH, 39);
set_hitbox_value(AT_FAIR, 5, HG_HEIGHT, 29);
