set_attack_value(AT_UTILT, AG_CATEGORY, 2); //this attack has a jump.
...
set_window_value(AT_UTILT, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.05);

set_window_value(AT_UTILT, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_UTILT, 2, AG_WINDOW_LENGTH, 4);
set_window_value(AT_UTILT, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_UTILT, 2, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(AT_UTILT, 2, AG_WINDOW_VSPEED, -3.2); //jump.
...
//set_hitbox_value(AT_UTILT, 1, HG_DRIFT_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_Y, -69); 
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, 54);
...
//set_hitbox_value(AT_UTILT, 3, HG_DRIFT_MULTIPLIER, 0.5);
set_hitbox_value(AT_UTILT, 3, HG_HITSTUN_MULTIPLIER, 0.75);