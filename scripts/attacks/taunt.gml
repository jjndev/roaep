...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, sound_get("sharpen_edited_freesounds_nicktermer"));
...
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, sound_get("sharpen_edited_freesounds_nicktermer"));
