...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX_FRAME, get_window_value(AT_DTILT, 1, AG_WINDOW_LENGTH) - 1);
...
set_window_value(AT_DTILT, 4, AG_WINDOW_HAS_WHIFFLAG, 0);
...
set_hitbox_value(AT_DTILT, 1, HG_ANGLE, 75); //launcher.
//stun
