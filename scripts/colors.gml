...
set_color_profile_slot( 3, 4, 199, 196, 2 ); //claws
...
set_color_profile_slot( 13, 1, 138, 23, 10 ); //hair
set_color_profile_slot( 13, 2, 217, 167, 36 ); //cuffs
set_color_profile_slot( 13, 3, 242, 216, 102 ); //cuffs highlight
set_color_profile_slot( 13, 4, 143, 106, 98 ); //claws
set_color_profile_slot( 13, 5, 67, 207, 194 ); //scarf
